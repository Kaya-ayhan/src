...
public class gradeCalculator {
    public static void main(String[] args) {
        ...
        scores.addAll(Arrays.asList(100, 90, 75, 85, 65, 45, 73, 35, 47));
       ...
       // System.out.println(gradeOfF);
        ...
        System.out.println("Total number of A:"+ gradeOfA);
        System.out.println("Total number of B:"+ gradeOfB);
        System.out.println("Total number of C:"+ gradeOfC);
        System.out.println("Total number of D:"+ gradeOfD);
        System.out.println("Total number of F:"+ gradeOfF);
    }
}
